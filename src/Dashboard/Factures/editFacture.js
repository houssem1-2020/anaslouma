          ...
          .then(function (response) {
                if(!response.data[0]) {
                    ...
                    if(response.data[0].SDF == 'true'){
                        ...
                        setFactureD({ client:response.data[0].C_Name , de:response.data[0].De, vers:response.data[0].Vers, jour: new Date(response.data[0].Cre_Date).toISOString().split('T')[0], totale: response.data[0].Tota , articles:JSON.parse(response.data[0].Articles)})
                        setLoading(true)
                    }
                }
            })
